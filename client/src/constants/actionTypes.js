...
export const TOP_RATED_PAGE_LOADED='TOP_RATED_PAGE_LOADED'
export const TOP_RATED_PAGE_UNLOADED='TOP_RATED_PAGE_UNLOADED'
...
export const LIST_PAGE_UNLOADED = 'LIST_PAGE_UNLOADED';
export const LOGIN = 'LOGIN';
export const LOGOUT = 'LOGOUT';
export const LOAD_MORE='LOAD_MORE_PAGES';
...
export const UPDATE_MAIN_EDITOR = 'UPDATE_MAIN_EDITOR';
...
export const BOOKS_UNLOADED = 'BOOKS_UNLOADED';
export const BOOK_PAGE_LOADED ='BOOK_PAGE_LOADED';
export const BOOK_PAGE_UNLOADED = 'BOOK_PAGE_UNLOADED';
